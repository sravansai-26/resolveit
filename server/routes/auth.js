...
  // Removed redundant initializers for bio/avatar since User.js model provides defaults
});
...
  // ❌ REMOVED: console.log('Auth Routes JWT_SECRET (Signing):', process.env.JWT_SECRET);
...
    // Create user using only whitelisted fields
    const userData = pickUserFields(req.body); 
    // Add bio/avatar if provided, otherwise User.js model defaults will apply
